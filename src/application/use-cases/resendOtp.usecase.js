...
const resendOtp_validator_1 = require("../../validators/resendOtp.validator");
class ResendOtpUseCase {
    ...
    execute(email) {
        return __awaiter(this, void 0, void 0, function* () {
            yield resendOtp_validator_1.resendOtpSchema.validate({ email });
            ...
            const otp = new otp_entity_1.Otp(null, user._id, otpCode, 1, expiresAt);
            yield this.otpRepository.upsert(otp);
            yield (0, email_service_1.sendOtpEmail)(email, otpCode, true);
        });
    }
}
